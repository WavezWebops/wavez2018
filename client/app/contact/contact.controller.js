...
class ContactComponent {
  constructor() {
    this.cores = [{
        'name': 'Tony Anoop',
        'department': 'Events',
        'mobile': '+91 830 924 3496',
        'url': 'https://res.cloudinary.com/abinthomasonline/image/upload/c_scale,f_auto,q_auto:eco,w_250/v1488856666/Wavez2017/core/events.jpg',
        'mail': 'events@wavez.co.in'
    }, {
    	'name': 'Akhil',
    	'department': 'Finance',
        ...
        'url': 'https://res.cloudinary.com/abinthomasonline/image/upload/c_scale,f_auto,q_auto:eco,w_250/v1488856666/Wavez2017/core/fr2.jpg',
        'mail': 'contact@wavez.co.in'
    }, {
        'name': 'Anand',
